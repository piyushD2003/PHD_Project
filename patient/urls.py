...
urlpatterns = [
    ...
    path('create_insurance/', views.create_insurance_view, name='create_insurance'),
    path('my_insurance/', views.my_insurance_view, name='my_insurance'),
    ...
    path('labtests/', views.patient_labtests_view, name='patient_labtests'),
    path('labtest/<int:test_id>/', views.patient_labtest_detail, name='patient_labtest_detail'),
]
